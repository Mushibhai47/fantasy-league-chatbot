...
<head>
    ...
    <title>Razzbot</title>
    <link rel="stylesheet" href="<?php echo esc_url( RAZZBOT_PLUGIN_URL . 'assets/embed.css' ); ?>">
</head>
<body>
    <div id="razzball-chatbot-embed">
        ...
        <div id="setup-screen" class="screen active">
            <div class="setup-container">
                ...
                <div class="setup-step" id="step-upload">
                    ...
                    <p class="step-description">
                        Upload your Fantrax, CBS, or NFBC league export file
                    </p>
        ...
        <div id="chat-screen" class="screen">
            ...
            <div class="chat-input-container">
                <textarea
                    id="chat-input"
                    placeholder="Ask me anything about your fantasy baseball team..."
                    rows="2"
                ></textarea>
                    ...
                    <div class="setting-item">
                        ...
                        <div class="input-group">
                            <input
                                type="password"
                                id="settings-api-key"
                                placeholder="No API key - using free tier (100 messages/month)"
                                readonly
                            />
    ...
    <script src="<?php echo esc_url( RAZZBOT_PLUGIN_URL . 'assets/embed.js' ); ?>"></script>
</body>
</html>
